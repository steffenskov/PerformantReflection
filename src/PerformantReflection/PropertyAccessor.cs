...
public class PropertyAccessor
{
	...
	/// <summary>
	///     Whether or not the property has a getter, if no getter exists the GetValue method will throw an
	///     InvalidOperationException if invoked.
	/// </summary>
	public bool HasGetter => _getter is not null;

	/// <summary>
	///     Whether or not the property has a setter, if no setter exists the SetValue method will throw an
	///     InvalidOperationException if invoked.
	/// </summary>
	...
	/// <summary>
	///     Sets the property's value. The caller has to ensure the value has the proper type or an InvalidCastException will
	///     be thrown.
	/// </summary>
