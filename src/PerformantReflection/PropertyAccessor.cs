...
namespace PerformantReflection
{
    ...
    public class PropertyAccessor
	{
		...
		{
			if (_getter is null) throw new InvalidOperationException($"Property {Name} has no getter");
		...
		{
			if (_setter is null) throw new InvalidOperationException($"Property {Name} has no setter");
